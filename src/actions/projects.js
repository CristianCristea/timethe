...
export const startAddProject = (projectData = {}) => {
  // returned function is called internally by redux with dispatch and getState() arg
  // allows to get data from the state
...
export const startDeleteProject = (id) => {
  return (dispatch, getState) => {
    ...
    return database.ref(`users/${uid}/projects/${id}`).remove().then(() => dispatch(deleteProject(id)));
  };
};
